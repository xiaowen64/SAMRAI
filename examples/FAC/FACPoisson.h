/*
 * File:        $URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/examples/FAC/FACPoisson.h $
 ...
 * "fac_poisson", the input database for the solv::CellPoissonFACSolver<NDIM>
...
public:
   ...
   virtual void initializeLevelData (
      ...
      const tbox::Pointer<hier::BasePatchLevel<NDIM> >
         old_level=tbox::Pointer<hier::PatchLevel<NDIM> >((0)) ,
    ...
    * solv::CellPoissonFACSolver<NDIM> object to solve it.
    * -# Set initial guess
    ...
    *
    * @param viz_writer Vizramrai writer
    */
   int setupPlotter(
      appu::CartesianVizamraiDataWriter<NDIM> &plotter ) const;
    ...
    */
   int setupPlotter(
      appu::VisItDataWriter<NDIM> &plotter ) const;
...
private:
   ...
   */
  solv::CellPoissonFACSolver<NDIM> d_poisson_fac_solver;
