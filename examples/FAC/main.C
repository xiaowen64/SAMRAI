/*
 * File:        $URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/examples/FAC/main.C $
...
int main( int argc, char *argv[] )
{
    ...
    */
   {
	 ...
	 new geom::CartesianGridGeometry<NDIM>(base_name+"CartesianGridGeometry",
	 ...
	 new mesh::StandardTagAndInitialize<NDIM>(
	    "CellTaggingMethod" ,
	    tbox::Pointer<mesh::StandardTagAndInitStrategy<NDIM> >(&fac_poisson,false) ,
	 ...
	 fac_poisson.setupPlotter(*vizam_writer);
      }
      if ( use_visit ) {
