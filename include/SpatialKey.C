//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-0/source/mesh/load_balance/SpatialKey.C $
...
*                                                                          *
* Uses sprintf() to create string because the behavior of C++ stream       *
