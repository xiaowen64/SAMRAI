//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/patchdata/operators/time_interpolate/side/SideFloatLinearTimeInterpolateOp.C $
...
extern "C" {
// in lintimint1d.f:
   void lintimeintsidefloat1d_( const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const double&,
                                ...
                                float* );
// in lintimint2d.f:
   void lintimeintsidefloat2d0_( const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 ...
                                 const float*, const float*,
                                 float* );
   void lintimeintsidefloat2d1_( const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 ...
                                 float* );
// in lintimint3d.f:
   void lintimeintsidefloat3d0_( const int&, const int&, const int&,
                                 ...
                                 const float*, const float*,
                                 float* );
   void lintimeintsidefloat3d1_( const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 ...
                                 const float*, const float*,
                                 float* );
   void lintimeintsidefloat3d2_( const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
...
template<int DIM> SideFloatLinearTimeInterpolateOp<DIM>::SideFloatLinearTimeInterpolateOp()
...
template<int DIM> bool SideFloatLinearTimeInterpolateOp<DIM>::findTimeInterpolateOperator(
...
template<int DIM> void SideFloatLinearTimeInterpolateOp<DIM>::timeInterpolate(
...
{
   const SideData<DIM,float> *old_dat =
      dynamic_cast<const SideData<DIM,float> *>(&src_data_old);
   const SideData<DIM,float> *new_dat =
      dynamic_cast<const SideData<DIM,float> *>(&src_data_new);
   SideData<DIM,float> *dst_dat = 
      dynamic_cast<SideData<DIM,float> *>(&dst_data);
   ...
   for (int d = 0; d < dst_dat->getDepth(); d++) {
      if (DIM == 1) {
	 if (directions(0)) {
	    lintimeintsidefloat1d_(ifirst(0),ilast(0),
				   old_ilo(0),old_ihi(0),
				   new_ilo(0),new_ihi(0),
				   dst_ilo(0),dst_ihi(0),
				   tfrac,
	 ...
	 if (directions(0)) {
	    lintimeintsidefloat2d0_(ifirst(0),ifirst(1),ilast(0),ilast(1),
	 ...
	 if (directions(1)) {
	    lintimeintsidefloat2d1_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				    old_ilo(0),old_ilo(1),old_ihi(0),old_ihi(1),
				    new_ilo(0),new_ilo(1),new_ihi(0),new_ihi(1),
				    dst_ilo(0),dst_ilo(1),dst_ihi(0),dst_ihi(1),
				    tfrac,
	 ...
	 if (directions(0)) {
	    lintimeintsidefloat3d0_(ifirst(0),ifirst(1),ifirst(2),
	 ...
	 if (directions(1)) {
	    lintimeintsidefloat3d1_(ifirst(0),ifirst(1),ifirst(2),
				    ilast(0),ilast(1),ilast(2),
				    old_ilo(0),old_ilo(1),old_ilo(2),
				    old_ihi(0),old_ihi(1),old_ihi(2),
				    new_ilo(0),new_ilo(1),new_ilo(2),
	 ...
	 if (directions(2)) {
	    lintimeintsidefloat3d2_(ifirst(0),ifirst(1),ifirst(2),
				    ilast(0),ilast(1),ilast(2),
				    old_ilo(0),old_ilo(1),old_ilo(2),
				    old_ihi(0),old_ihi(1),old_ihi(2),
				    new_ilo(0),new_ilo(1),new_ilo(2),
	 ...
	 TBOX_ERROR("SideFloatLinearTimeInterpolateOp::TimeInterpolate DIM > 3 not supported" << std::endl);
      }
   }
}
