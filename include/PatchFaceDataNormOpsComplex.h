//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/face/PatchFaceDataNormOpsComplex.h $
...
/**
 * Class PatchFaceDataNormOpsComplex<DIM> provides a collection of common 
 ...
 * PatchFaceDataOpsComplex<DIM> class which provides access to operations 
 ...
 * patch data (double and float) in the class PatchFaceDataNormOpsReal<DIM>.
 *
...
public:
    ...
    */
   int numberOfEntries(const tbox::Pointer< pdat::FaceData<DIM,dcomplex> >& data,
    ...
    */
   void abs(tbox::Pointer< pdat::FaceData<DIM,double> >& dst,
...
private:
   ...
   PatchFaceDataNormOpsComplex(const PatchFaceDataNormOpsComplex<DIM>&);
   void operator=(const PatchFaceDataNormOpsComplex<DIM>&);
...
#include "PatchFaceDataNormOpsComplex.C"
#endif
