//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/patchdata/operators/time_interpolate/outerside/OutersideDoubleLinearTimeInterpolateOp.C $
...
extern "C" {
// in lintimint1d.f:
   void lintimeintoutsidedoub1d_( const int&, const int&,
                                  const int&, const int&,
                                  const int&, const int&,
                                  const int&, const int&,
                                  const double&,
                                  ...
                                  double* );
// in lintimint2d.f:
   void lintimeintoutsidedoub2d0_( const int&, const int&,
                                   const int&, const int&,
                                   const int&, const int&,
                                   const int&, const int&,
                                   const int&, const int&,
                                   ...
                                   const double*, const double*,
                                   double* );
   void lintimeintoutsidedoub2d1_( const int&, const int&,
                                   const int&, const int&,
                                   const int&, const int&,
                                   const int&, const int&,
                                   const int&, const int&,
                                   ...
                                   double* );
// in lintimint3d.f:
   void lintimeintoutsidedoub3d0_( const int&, const int&, const int&,
                                   ...
                                   const double*, const double*,
                                   double* );
   void lintimeintoutsidedoub3d1_( const int&, const int&, const int&,
                                   const int&, const int&, const int&,
                                   const int&, const int&, const int&,
                                   const int&, const int&, const int&,
                                   const int&, const int&, const int&,
                                   ...
                                   const double*, const double*,
                                   double* );
   void lintimeintoutsidedoub3d2_( const int&, const int&, const int&,
                                   const int&, const int&, const int&,
                                   const int&, const int&, const int&,
                                   const int&, const int&, const int&,
                                   const int&, const int&, const int&,
...
template<int DIM> OutersideDoubleLinearTimeInterpolateOp<DIM>::OutersideDoubleLinearTimeInterpolateOp()
...
template<int DIM> bool OutersideDoubleLinearTimeInterpolateOp<DIM>::findTimeInterpolateOperator(
   const tbox::Pointer< hier::Variable<DIM> >& var,
   const std::string &op_name) const
{
   const tbox::Pointer< OutersideVariable<DIM,double> > cast_var(var);
...
template<int DIM> void OutersideDoubleLinearTimeInterpolateOp<DIM>::timeInterpolate(
   ...
   const hier::PatchData<DIM>& src_data_new) const
{
   ...
   const OutersideData<DIM,double> *old_dat =
      dynamic_cast<const OutersideData<DIM,double> *>(&src_data_old);
   const OutersideData<DIM,double> *new_dat =
      dynamic_cast<const OutersideData<DIM,double> *>(&src_data_new);
   OutersideData<DIM,double> *dst_dat = 
      dynamic_cast<OutersideData<DIM,double> *>(&dst_data);
   ...
   for (int d = 0; d < dst_dat->getDepth(); d++) {
      ...
      for (int i = 0; i < 2; i++) {
	 if (DIM == 1) {
	    lintimeintoutsidedoub1d_(ifirst(0),ilast(0),
				     old_ilo(0),old_ihi(0),
				     new_ilo(0),new_ihi(0),
				     dst_ilo(0),dst_ihi(0),
				     tfrac,
	    ...
	    lintimeintoutsidedoub2d0_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				      ...
				      new_dat->getPointer(0,i,d),
				      dst_dat->getPointer(0,i,d));
	    lintimeintoutsidedoub2d1_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				      old_ilo(0),old_ilo(1),old_ihi(0),old_ihi(1),
				      new_ilo(0),new_ilo(1),new_ihi(0),new_ihi(1),
				      dst_ilo(0),dst_ilo(1),dst_ihi(0),dst_ihi(1),
				      tfrac,
	    ...
	    lintimeintoutsidedoub3d0_(ifirst(0),ifirst(1),ifirst(2),
				      ...
				      new_dat->getPointer(0,i,d),
				      dst_dat->getPointer(0,i,d));
	    lintimeintoutsidedoub3d1_(ifirst(0),ifirst(1),ifirst(2),
				      ilast(0),ilast(1),ilast(2),
				      old_ilo(0),old_ilo(1),old_ilo(2),
				      old_ihi(0),old_ihi(1),old_ihi(2),
				      new_ilo(0),new_ilo(1),new_ilo(2),
				      ...
				      new_dat->getPointer(1,i,d),
				      dst_dat->getPointer(1,i,d));
	    lintimeintoutsidedoub3d2_(ifirst(0),ifirst(1),ifirst(2),
				      ilast(0),ilast(1),ilast(2),
				      old_ilo(0),old_ilo(1),old_ilo(2),
				      old_ihi(0),old_ihi(1),old_ihi(2),
				      new_ilo(0),new_ilo(1),new_ilo(2),
	    ...
	    TBOX_ERROR("OutersideDoubleLienarTimeInterpolate::TimeInterpolate DIM > 3 not supported" << std::endl);
	 }
      }
   }
}
