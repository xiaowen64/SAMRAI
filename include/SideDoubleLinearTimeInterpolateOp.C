//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/patchdata/operators/time_interpolate/side/SideDoubleLinearTimeInterpolateOp.C $
...
extern "C" {
// in lintimint1d.f:
   void lintimeintsidedoub1d_( const int&, const int&,
                               const int&, const int&,
                               const int&, const int&,
                               const int&, const int&,
                               const double&,
                               ...
                               double* );
// in lintimint2d.f:
   void lintimeintsidedoub2d0_( const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                ...
                                const double*, const double*,
                                double* );
   void lintimeintsidedoub2d1_( const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                ...
                                double* );
// in lintimint3d.f:
   void lintimeintsidedoub3d0_( const int&, const int&, const int&,
                                ...
                                const double*, const double*,
                                double* );
   void lintimeintsidedoub3d1_( const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                ...
                                const double*, const double*,
                                double* );
   void lintimeintsidedoub3d2_( const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
...
template<int DIM> SideDoubleLinearTimeInterpolateOp<DIM>::SideDoubleLinearTimeInterpolateOp()
...
template<int DIM> bool SideDoubleLinearTimeInterpolateOp<DIM>::findTimeInterpolateOperator(
   const tbox::Pointer< hier::Variable<DIM> >& var,
   const std::string &op_name) const
{
   const tbox::Pointer< SideVariable<DIM,double> > cast_var(var);
...
template<int DIM> void SideDoubleLinearTimeInterpolateOp<DIM>::timeInterpolate(
   ...
   const hier::PatchData<DIM>& src_data_new) const
{
   ...
   const SideData<DIM,double> *old_dat =
      dynamic_cast<const SideData<DIM,double> *>(&src_data_old);
   const SideData<DIM,double> *new_dat =
      dynamic_cast<const SideData<DIM,double> *>(&src_data_new);
   SideData<DIM,double> *dst_dat = 
      dynamic_cast<SideData<DIM,double> *>(&dst_data);
   ...
   for (int d = 0; d < dst_dat->getDepth(); d++) {
      if (DIM == 1) {
	 if (directions(0)) {
	    lintimeintsidedoub1d_(ifirst(0),ilast(0),
				  old_ilo(0),old_ihi(0),
				  new_ilo(0),new_ihi(0),
				  dst_ilo(0),dst_ihi(0),
				  tfrac,
	 ...
	 if (directions(0)) {
	    lintimeintsidedoub2d0_(ifirst(0),ifirst(1),ilast(0),ilast(1),
	 ...
	 if (directions(1)) {
	    lintimeintsidedoub2d1_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				   old_ilo(0),old_ilo(1),old_ihi(0),old_ihi(1),
				   new_ilo(0),new_ilo(1),new_ihi(0),new_ihi(1),
				   dst_ilo(0),dst_ilo(1),dst_ihi(0),dst_ihi(1),
				   tfrac,
	 ...
	 if (directions(0)) {
	    lintimeintsidedoub3d0_(ifirst(0),ifirst(1),ifirst(2),
	 ...
	 if (directions(1)) {
	    lintimeintsidedoub3d1_(ifirst(0),ifirst(1),ifirst(2),
				   ilast(0),ilast(1),ilast(2),
				   old_ilo(0),old_ilo(1),old_ilo(2),
				   old_ihi(0),old_ihi(1),old_ihi(2),
				   new_ilo(0),new_ilo(1),new_ilo(2),
	 ...
	 if (directions(2)) {
	    lintimeintsidedoub3d2_(ifirst(0),ifirst(1),ifirst(2),
				   ilast(0),ilast(1),ilast(2),
				   old_ilo(0),old_ilo(1),old_ilo(2),
				   old_ihi(0),old_ihi(1),old_ihi(2),
				   new_ilo(0),new_ilo(1),new_ilo(2),
	 ...
	 TBOX_ERROR("SideDoubleLinearTimeInterpolateOp::TimeInterpolate DIM > 3 not supported" << std::endl);
      }
   }
}
