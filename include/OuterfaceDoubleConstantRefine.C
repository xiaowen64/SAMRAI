//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/patchdata/operators/constant/outerface/OuterfaceDoubleConstantRefine.C $
   ...
   const hier::IntVector<DIM>& ratio) const
{
   ...
   for (int d = 0; d < fdata->getDepth(); d++) {
	 ...
	 if (DIM == 1) {
	    ...
	    TBOX_ERROR("OuterfaceDoubleConstantRefine::refine DIM > 3 not supported" << std::endl);
	 }
      }
   }
}
