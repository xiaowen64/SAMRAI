//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/patchdata/boxgeometry/FaceOverlap.h $
...
public:
   ...
   /**
    * Return the list of boxes (in face centered index space) that constitute
