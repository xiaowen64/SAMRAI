//
// File:        $URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/algorithm/implicit/ImplicitEquationStrategy.h $
...
/*!
  ...
  ImplicitIntegrator<DIM> object and routines
...
*/
template<int DIM> class ImplicitEquationStrategy 
{
public:
   /**
   ...
   virtual void setupSolutionVector(
      tbox::Pointer< solv::SAMRAIVectorReal<DIM,double> > solution ) = 0;
