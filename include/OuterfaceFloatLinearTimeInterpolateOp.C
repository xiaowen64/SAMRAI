//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/patchdata/operators/time_interpolate/outerface/OuterfaceFloatLinearTimeInterpolateOp.C $
...
extern "C" {
// in lintimint1d.f:
   void lintimeintoutfacefloat1d_( const int&, const int&,
                                   const int&, const int&,
                                   const int&, const int&,
                                   const int&, const int&,
                                   const double&,
                                   ...
                                   float* );
// in lintimint2d.f:
   void lintimeintoutfacefloat2d0_( const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    ...
                                    const float*, const float*,
                                    float* );
   void lintimeintoutfacefloat2d1_( const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    ...
                                    float* );
// in lintimint3d.f:
   void lintimeintoutfacefloat3d0_( const int&, const int&, const int&,
                                    ...
                                    const float*, const float*,
                                    float* );
   void lintimeintoutfacefloat3d1_( const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    ...
                                    const float*, const float*,
                                    float* );
   void lintimeintoutfacefloat3d2_( const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
...
template<int DIM> OuterfaceFloatLinearTimeInterpolateOp<DIM>::OuterfaceFloatLinearTimeInterpolateOp()
...
template<int DIM> bool OuterfaceFloatLinearTimeInterpolateOp<DIM>::findTimeInterpolateOperator(
...
template<int DIM> void OuterfaceFloatLinearTimeInterpolateOp<DIM>::timeInterpolate(
...
{
   const OuterfaceData<DIM,float> *old_dat =
      dynamic_cast<const OuterfaceData<DIM,float> *>(&src_data_old);
   const OuterfaceData<DIM,float> *new_dat =
      dynamic_cast<const OuterfaceData<DIM,float> *>(&src_data_new);
   OuterfaceData<DIM,float> *dst_dat = 
      dynamic_cast<OuterfaceData<DIM,float> *>(&dst_data);
   ...
   for (int d = 0; d < dst_dat->getDepth(); d++) {
      ...
      for (int i = 0; i < 2; i++) {
	 if (DIM == 1) {
	    lintimeintoutfacefloat1d_(ifirst(0),ilast(0),
				      old_ilo(0),old_ihi(0),
				      new_ilo(0),new_ihi(0),
				      dst_ilo(0),dst_ihi(0),
				      tfrac,
	    ...
	    lintimeintoutfacefloat2d0_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				       ...
				       new_dat->getPointer(0,i,d),
				       dst_dat->getPointer(0,i,d));
	    lintimeintoutfacefloat2d1_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				       old_ilo(0),old_ilo(1),old_ihi(0),old_ihi(1),
				       new_ilo(0),new_ilo(1),new_ihi(0),new_ihi(1),
				       dst_ilo(0),dst_ilo(1),dst_ihi(0),dst_ihi(1),
				       tfrac,
	    ...
	    lintimeintoutfacefloat3d0_(ifirst(0),ifirst(1),ifirst(2),
				       ...
				       new_dat->getPointer(0,i,d),
				       dst_dat->getPointer(0,i,d));
	    lintimeintoutfacefloat3d1_(ifirst(0),ifirst(1),ifirst(2),
				       ilast(0),ilast(1),ilast(2),
				       old_ilo(0),old_ilo(1),old_ilo(2),
				       old_ihi(0),old_ihi(1),old_ihi(2),
				       new_ilo(0),new_ilo(1),new_ilo(2),
				       ...
				       new_dat->getPointer(1,i,d),
				       dst_dat->getPointer(1,i,d));
	    lintimeintoutfacefloat3d2_(ifirst(0),ifirst(1),ifirst(2),
				       ilast(0),ilast(1),ilast(2),
				       old_ilo(0),old_ilo(1),old_ilo(2),
				       old_ihi(0),old_ihi(1),old_ihi(2),
				       new_ilo(0),new_ilo(1),new_ilo(2),
	    ...
	    TBOX_ERROR("OuterfaceFloatLinearTimeInterpolateOp::TimeInterpolate DIM > 3 not supported" << std::endl);
	 }
      }
   }
}
