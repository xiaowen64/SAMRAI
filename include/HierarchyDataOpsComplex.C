//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/hierarchy/HierarchyDataOpsComplex.C $
...
template<int DIM>  HierarchyDataOpsComplex<DIM>::HierarchyDataOpsComplex()
{
}
