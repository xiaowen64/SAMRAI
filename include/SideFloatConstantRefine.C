//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/patchdata/operators/constant/side/SideFloatConstantRefine.C $
...
extern "C" {
// in conrefine1d.f:
   void conrefsideflot1d_( const int&, const int&,
                           const int&, const int&,
                           const int&, const int&,
                           const int&, const int&,
                           const int*,
                           const float*, float* );
// in conrefine2d.f:
   void conrefsideflot2d0_( const int&, const int&, const int&, const int&,
                            const int&, const int&, const int&, const int&,
                            const int&, const int&, const int&, const int&,
                            const int&, const int&, const int&, const int&,
                            const int*,
                            const float*, float* );
   void conrefsideflot2d1_( const int&, const int&, const int&, const int&,
                            const int&, const int&, const int&, const int&,
                            const int&, const int&, const int&, const int&,
                            const int&, const int&, const int&, const int&,
                            const int*,
                            const float*, float* );
// in conrefine3d.f:
   void conrefsideflot3d0_( const int&, const int&, const int&,
                            ...
                            const int*,
                            const float*, float* );
   void conrefsideflot3d1_( const int&, const int&, const int&,
                            const int&, const int&, const int&,
                            const int&, const int&, const int&,
                            const int&, const int&, const int&,
                            const int&, const int&, const int&,
                            ...
                            const int*,
                            const float*, float* );
   void conrefsideflot3d2_( const int&, const int&, const int&,
                            const int&, const int&, const int&,
                            const int&, const int&, const int&,
                            const int&, const int&, const int&,
                            const int&, const int&, const int&,
...
template<int DIM> SideFloatConstantRefine<DIM>::SideFloatConstantRefine()
...
template<int DIM> int SideFloatConstantRefine<DIM>::getOperatorPriority() const
{
   return(0);
}

template<int DIM> hier::IntVector<DIM> 
SideFloatConstantRefine<DIM>::getStencilWidth() const {
   return(hier::IntVector<DIM>(0));
}

template<int DIM> void SideFloatConstantRefine<DIM>::refine(
   hier::Patch<DIM>& fine, 
   ...
   const hier::IntVector<DIM>& ratio) const
{
   ...
   for (int d = 0; d < fdata->getDepth(); d++) {
      if (DIM == 1) {
	 if (directions(0)) {
	    conrefsideflot1d_(ifirstc(0),ilastc(0),
			      ifirstf(0),ilastf(0),
			      cilo(0),cihi(0),
			      filo(0),fihi(0),
			      ratio,
	 ...
	 if (directions(0)) {
	    conrefsideflot2d0_(ifirstc(0),ifirstc(1),ilastc(0),ilastc(1),
	 ...
	 if (directions(1)) {
	    conrefsideflot2d1_(ifirstc(0),ifirstc(1),ilastc(0),ilastc(1),
			       ifirstf(0),ifirstf(1),ilastf(0),ilastf(1),
			       cilo(0),cilo(1),cihi(0),cihi(1),
			       filo(0),filo(1),fihi(0),fihi(1),
			       ratio,
	 ...
	 if (directions(0)) {
	    conrefsideflot3d0_(ifirstc(0),ifirstc(1),ifirstc(2),
	 ...
	 if (directions(1)) {
	    conrefsideflot3d1_(ifirstc(0),ifirstc(1),ifirstc(2),
			       ilastc(0),ilastc(1),ilastc(2),
			       ifirstf(0),ifirstf(1),ifirstf(2),
			       ilastf(0),ilastf(1),ilastf(2),
			       cilo(0),cilo(1),cilo(2),
	 ...
	 if (directions(2)) {
	    conrefsideflot3d2_(ifirstc(0),ifirstc(1),ifirstc(2),
			       ilastc(0),ilastc(1),ilastc(2),
			       ifirstf(0),ifirstf(1),ifirstf(2),
			       ilastf(0),ilastf(1),ilastf(2),
			       cilo(0),cilo(1),cilo(2),
