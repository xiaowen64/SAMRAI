//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/patchdata/operators/time_interpolate/edge/EdgeFloatLinearTimeInterpolateOp.C $
...
extern "C" {
// in lintimint1d.f:
   void lintimeintedgefloat1d_( const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const double&,
                                ...
                                float* );
// in lintimint2d.f:
   void lintimeintedgefloat2d0_( const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 ...
                                 const float*, const float*,
                                 float* );
   void lintimeintedgefloat2d1_( const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 const int&, const int&,
                                 ...
                                 float* );
// in lintimint3d.f:
   void lintimeintedgefloat3d0_( const int&, const int&, const int&,
                                 ...
                                 const float*, const float*,
                                 float* );
   void lintimeintedgefloat3d1_( const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 ...
                                 const float*, const float*,
                                 float* );
   void lintimeintedgefloat3d2_( const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
                                 const int&, const int&, const int&,
...
template<int DIM> EdgeFloatLinearTimeInterpolateOp<DIM>::EdgeFloatLinearTimeInterpolateOp()
...
template<int DIM> bool EdgeFloatLinearTimeInterpolateOp<DIM>::findTimeInterpolateOperator(
...
template<int DIM> void EdgeFloatLinearTimeInterpolateOp<DIM>::timeInterpolate(
   ...
   const hier::PatchData<DIM>& src_data_new) const
{
   ...
   const EdgeData<DIM,float> *old_dat =
      dynamic_cast<const EdgeData<DIM,float> *>(&src_data_old);
   const EdgeData<DIM,float> *new_dat =
      dynamic_cast<const EdgeData<DIM,float> *>(&src_data_new);
   EdgeData<DIM,float> *dst_dat = 
      dynamic_cast<EdgeData<DIM,float> *>(&dst_data);
   ...
   for (int d = 0; d < dst_dat->getDepth(); d++) {
      if (DIM == 1) {
	 lintimeintedgefloat1d_(ifirst(0),ilast(0),
				old_ilo(0),old_ihi(0),
				new_ilo(0),new_ihi(0),
				dst_ilo(0),dst_ihi(0),
				tfrac,
	 ...
	 lintimeintedgefloat2d0_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				 ...
				 new_dat->getPointer(0,d),
				 dst_dat->getPointer(0,d));
	 lintimeintedgefloat2d1_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				 old_ilo(0),old_ilo(1),old_ihi(0),old_ihi(1),
				 new_ilo(0),new_ilo(1),new_ihi(0),new_ihi(1),
				 dst_ilo(0),dst_ilo(1),dst_ihi(0),dst_ihi(1),
				 tfrac,
	 ...
	 lintimeintedgefloat3d0_(ifirst(0),ifirst(1),ifirst(2),
				 ...
				 new_dat->getPointer(0,d),
				 dst_dat->getPointer(0,d));
	 lintimeintedgefloat3d1_(ifirst(0),ifirst(1),ifirst(2),
				 ilast(0),ilast(1),ilast(2),
				 old_ilo(0),old_ilo(1),old_ilo(2),
				 old_ihi(0),old_ihi(1),old_ihi(2),
				 new_ilo(0),new_ilo(1),new_ilo(2),
				 ...
				 new_dat->getPointer(1,d),
				 dst_dat->getPointer(1,d));
	 lintimeintedgefloat3d2_(ifirst(0),ifirst(1),ifirst(2),
				 ilast(0),ilast(1),ilast(2),
				 old_ilo(0),old_ilo(1),old_ilo(2),
				 old_ihi(0),old_ihi(1),old_ihi(2),
				 new_ilo(0),new_ilo(1),new_ilo(2),
	 ...
	 TBOX_ERROR("EdgeFloatLinearTimeInterpolateOp DIM::TimeInterpolate DIM > 3 not supported" << std::endl);
      }
   }
}
