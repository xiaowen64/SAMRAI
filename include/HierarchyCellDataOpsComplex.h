//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/cell/HierarchyCellDataOpsComplex.h $
...
/**
 * Class HierarchyCellDataOpsComplex<DIM> provides a collection of 
 ...
 * PatchCellDataOpsComplex<DIM> data member.
 * 
 ...
 * HierarchyCellDataOpsReal<DIM> and HierarchyCellDataOpsInteger<DIM>, 
 * respectively.
 * 
...
template<int DIM>
class HierarchyCellDataOpsComplex : public HierarchyDataOpsComplex<DIM>
{
public:
   /**
    * The constructor for the HierarchyCellDataOpsComplex<DIM> class sets
...
private:
   ...
   HierarchyCellDataOpsComplex(const HierarchyCellDataOpsComplex<DIM>&);
   void operator=(const HierarchyCellDataOpsComplex<DIM>&);

   tbox::Pointer< hier::PatchHierarchy<DIM> > d_hierarchy;
   int  d_coarsest_level;
   int  d_finest_level; 
   PatchCellDataOpsComplex<DIM> d_patch_ops;
