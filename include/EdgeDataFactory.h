...
public:
    ...
    * will be used in the instantiation of concrete edge data objects.
    */
    ...
    * will be used in the instantiation of concrete edge data instances.
    */
