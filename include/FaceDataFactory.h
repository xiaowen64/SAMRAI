...
public:
    ...
    * will be used in the instantiation of concrete face data objects.
    */
    ...
    * will be used in the instantiation of concrete face data instances.
    */
