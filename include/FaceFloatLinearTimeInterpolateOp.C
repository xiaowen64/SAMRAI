//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/patchdata/operators/time_interpolate/face/FaceFloatLinearTimeInterpolateOp.C $
   ...
   const hier::PatchData<DIM>& src_data_new) const
{
   ...
   for (int d = 0; d < dst_dat->getDepth(); d++) {
	 ...
	 TBOX_ERROR("FaceFloatLinearTimeInterpolateOp::TimeInterpolate DIM > 3 not supported" << std::endl);
      }
   }
}
