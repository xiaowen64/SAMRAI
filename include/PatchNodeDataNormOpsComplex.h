//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/node/PatchNodeDataNormOpsComplex.h $
...
/**
 * Class PatchNodeDataNormOpsComplex<DIM> provides a collection of common 
 ...
 * PatchNodeDataOpsComplex<DIM> class which provides access to operations 
 ...
 * patch data (double and float) in the class PatchNodeDataNormOpsReal<DIM>.
 *
...
public:
    ...
    */
   int numberOfEntries(const tbox::Pointer< pdat::NodeData<DIM,dcomplex> >& data,
    ...
    */
   void abs(tbox::Pointer< pdat::NodeData<DIM,double> >& dst,
...
private:
   ...
   PatchNodeDataNormOpsComplex(const PatchNodeDataNormOpsComplex<DIM>&);
   void operator=(const PatchNodeDataNormOpsComplex<DIM>&);
