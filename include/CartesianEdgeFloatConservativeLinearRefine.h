//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/geometry/cartesian/operators/edge/CartesianEdgeFloatConservativeLinearRefine.h $
 ...
 * variable is edge-centered float, and the string is 
 * "CONSERVATIVE_LINEAR_REFINE".
 * 
 * @see xfer::RefineOperator
 */

template<int DIM> class CartesianEdgeFloatConservativeLinearRefine 
