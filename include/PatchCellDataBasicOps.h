//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/cell/PatchCellDataBasicOps.h $
...
private:
   ...
   PatchCellDataBasicOps(
      const PatchCellDataBasicOps<DIM,TYPE>&);
   void operator=(const PatchCellDataBasicOps<DIM,TYPE>&);
