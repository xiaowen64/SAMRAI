//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/geometry/cartesian/operators/face/CartesianFaceDoubleWeightedAverage.h $
 ...
 * variable is face-centered double, and the string is "CONSERVATIVE_COARSEN".
 * 
 * @see xfer::CoarsenOperator
 */

template<int DIM> class CartesianFaceDoubleWeightedAverage 
...
#include "CartesianFaceDoubleWeightedAverage.C"
#endif
