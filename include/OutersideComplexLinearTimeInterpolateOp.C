//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/patchdata/operators/time_interpolate/outerside/OutersideComplexLinearTimeInterpolateOp.C $
...
extern "C" {
// in lintimint1d.f:
   void lintimeintoutsidecmplx1d_( const int&, const int&,
                                   const int&, const int&,
                                   const int&, const int&,
                                   const int&, const int&,
                                   const double&,
                                   ...
                                   dcomplex* );
// in lintimint2d.f:
   void lintimeintoutsidecmplx2d0_( const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    ...
                                    const dcomplex*, const dcomplex*,
                                    dcomplex* );
   void lintimeintoutsidecmplx2d1_( const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    const int&, const int&,
                                    ...
                                    dcomplex* );
// in lintimint3d.f:
   void lintimeintoutsidecmplx3d0_( const int&, const int&, const int&,
                                    ...
                                    const dcomplex*, const dcomplex*,
                                    dcomplex* );
   void lintimeintoutsidecmplx3d1_( const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    ...
                                    const dcomplex*, const dcomplex*,
                                    dcomplex* );
   void lintimeintoutsidecmplx3d2_( const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
                                    const int&, const int&, const int&,
...
template<int DIM> OutersideComplexLinearTimeInterpolateOp<DIM>::OutersideComplexLinearTimeInterpolateOp()
...
template<int DIM> bool OutersideComplexLinearTimeInterpolateOp<DIM>::findTimeInterpolateOperator(
   const tbox::Pointer< hier::Variable<DIM> >& var,
   const std::string &op_name) const
{
   const tbox::Pointer< OutersideVariable<DIM,dcomplex> > cast_var(var);
...
template<int DIM> void OutersideComplexLinearTimeInterpolateOp<DIM>::timeInterpolate(
   ...
   const hier::PatchData<DIM>& src_data_new) const
{
   ...
   const OutersideData<DIM,dcomplex> *old_dat =
      dynamic_cast<const OutersideData<DIM,dcomplex> *>(&src_data_old);
   const OutersideData<DIM,dcomplex> *new_dat =
      dynamic_cast<const OutersideData<DIM,dcomplex> *>(&src_data_new);
   OutersideData<DIM,dcomplex> *dst_dat = 
      dynamic_cast<OutersideData<DIM,dcomplex> *>(&dst_data);
   ...
   for (int d = 0; d < dst_dat->getDepth(); d++) {
      ...
      for (int i = 0; i < 2; i++) {
	 if (DIM == 1) {
	    lintimeintoutsidecmplx1d_(ifirst(0),ilast(0),
				      old_ilo(0),old_ihi(0),
				      new_ilo(0),new_ihi(0),
				      dst_ilo(0),dst_ihi(0),
				      tfrac,
	    ...
	    lintimeintoutsidecmplx2d0_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				       ...
				       new_dat->getPointer(0,i,d),
				       dst_dat->getPointer(0,i,d));
	    lintimeintoutsidecmplx2d1_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				       old_ilo(0),old_ilo(1),old_ihi(0),old_ihi(1),
				       new_ilo(0),new_ilo(1),new_ihi(0),new_ihi(1),
				       dst_ilo(0),dst_ilo(1),dst_ihi(0),dst_ihi(1),
				       tfrac,
	    ...
	    lintimeintoutsidecmplx3d0_(ifirst(0),ifirst(1),ifirst(2),
				       ...
				       new_dat->getPointer(0,i,d),
				       dst_dat->getPointer(0,i,d));
	    lintimeintoutsidecmplx3d1_(ifirst(0),ifirst(1),ifirst(2),
				       ilast(0),ilast(1),ilast(2),
				       old_ilo(0),old_ilo(1),old_ilo(2),
				       old_ihi(0),old_ihi(1),old_ihi(2),
				       new_ilo(0),new_ilo(1),new_ilo(2),
				       ...
				       new_dat->getPointer(1,i,d),
				       dst_dat->getPointer(1,i,d));
	    lintimeintoutsidecmplx3d2_(ifirst(0),ifirst(1),ifirst(2),
				       ilast(0),ilast(1),ilast(2),
				       old_ilo(0),old_ilo(1),old_ilo(2),
				       old_ihi(0),old_ihi(1),old_ihi(2),
				       new_ilo(0),new_ilo(1),new_ilo(2),
	    ...
	    TBOX_ERROR("OutersideComplexLinearTimeInterpolateOp::TimeInterpolate DIM > 3 not supported" << std::endl);
	 }
      }
   }
}
