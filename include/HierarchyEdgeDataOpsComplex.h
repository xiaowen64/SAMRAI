//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/edge/HierarchyEdgeDataOpsComplex.h $
...
/**
 * Class HierarchyEdgeDataOpsComplex<DIM> provides a collection of 
 ...
 * PatchEdgeDataOpsComplex<DIM> data member.
 *
 ...
 * HierarchyEdgeDataOpsReal<DIM> and HierarchyEdgeDataOpsInteger<DIM>, 
 * respectively.
 * 
...
template<int DIM>
class HierarchyEdgeDataOpsComplex : public HierarchyDataOpsComplex<DIM>
{
public:
   /**
    * The constructor for the HierarchyEdgeDataOpsComplex<DIM> class sets
...
private:
   ...
   HierarchyEdgeDataOpsComplex(const HierarchyEdgeDataOpsComplex<DIM>&);
   void operator=(const HierarchyEdgeDataOpsComplex<DIM>&);
