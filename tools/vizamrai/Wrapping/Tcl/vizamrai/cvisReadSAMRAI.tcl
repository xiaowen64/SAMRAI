##
## File:        $URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/tools/vizamrai/Wrapping/Tcl/vizamrai/cvisReadSAMRAI.tcl $
## Package:     Vizamrai
...
class cvisReadSAMRAI { 
	...
	vtkSamraiStructuredPointsReader $name.cvisReadSAMRAI
	set Reader $name.cvisReadSAMRAI
