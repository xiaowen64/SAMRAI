##
## File:        $URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/tools/vizamrai/Wrapping/Tcl/vizamrai/cvisReadSAMRAIVectorInterface.tcl $
## Package:     Vizamrai
...
class cvisReadSAMRAIVectorInterface {
	...
	if {[string compare $filename $FileName] || \
	    ...
	    set NumVariables 0
	    for {set i 0} { $i < [$Reader GetNumberOfVariables] } {incr i} {
		set depth [$Reader GetDepth $i]
