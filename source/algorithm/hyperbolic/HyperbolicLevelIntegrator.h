...
/**
 * Class HyperbolicLevelIntegrator<DIM> provides routines needed to 
...
: 
public TimeRefinementLevelStrategy<DIM>,
...
public:
   ...
   /**
    * Constructor for HyperbolicLevelIntegrator<DIM> initializes
    ...
    */
   virtual void 
   registerVariable(const tbox::Pointer< hier::Variable<DIM> > var, 
    ...
    * in the concrete HyperbolicPatchStrategy<DIM> object manipulate;
...
protected:
    ...
    */
   virtual void
   preprocessFluxData(const tbox::Pointer< hier::PatchLevel<DIM> > level,
    ...
    */
   virtual void
   postprocessFluxData(const tbox::Pointer< hier::PatchLevel<DIM> > level,
                       const bool regrid_advance,
                       const bool first_step,
                       const bool last_step);
    ...
    */
   virtual void
   synchronizeLevelWithCoarser(const tbox::Pointer< hier::PatchLevel<DIM> > fine,
 ...
 */
    ...
    * HyperbolicLevelIntegrator<DIM> second occurs when the dt calculation is
    ...
    * accompanying HyperbolicLevelIntegrator<DIM>::advanceLevel.
    */
