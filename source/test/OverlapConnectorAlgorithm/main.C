   ...
   char* argv[])
{
    ...
    */
   {
...

      {
         ...
         dim(
            static_cast<tbox::Dimension::dir_t>(main_db->getInteger("dim")));
         ...
         while (true) {
            ...
            PrimitiveBoxGen
            pb1(
               * test_db->getDatabase("PrimitiveBoxGen1"),
               grid_geom);
            BoxContainer boxes1;
            ...
            l1(
               boxes1,
               IntVector::getOne(pb1.d_geom->getDim()),
               pb1.d_geom);
            l1.cacheGlobalReducedData();

            PrimitiveBoxGen
            pb2(
               * test_db->getDatabase("PrimitiveBoxGen2"),
               grid_geom);
            BoxContainer boxes2;
            ...
            l2(
               boxes2,
               IntVector::getOne(pb2.d_geom->getDim()),
               pb2.d_geom);
