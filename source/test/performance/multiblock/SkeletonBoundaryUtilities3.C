   ...
   int edge_btype)
{
   ...
   switch (edge_btype) {
      ...
      case BdryCond::XNEUMANN:
      {
         ...
         } else if (edge_loc == EdgeBdyLoc3D::XHI_ZLO || edge_loc == EdgeBdyLoc3D::XHI_ZHI ||
                    edge_loc == EdgeBdyLoc3D::XHI_YLO || edge_loc == EdgeBdyLoc3D::XHI_YHI) {
      ...
      case BdryCond::YNEUMANN:
      {
         ...
         } else if (edge_loc == EdgeBdyLoc3D::YHI_ZLO || edge_loc == EdgeBdyLoc3D::YHI_ZHI ||
                    edge_loc == EdgeBdyLoc3D::XLO_YHI || edge_loc == EdgeBdyLoc3D::XHI_YHI) {
      ...
      case BdryCond::ZNEUMANN:
      {
         ...
         } else if (edge_loc == EdgeBdyLoc3D::YLO_ZHI || edge_loc == EdgeBdyLoc3D::YHI_ZHI ||
                    edge_loc == EdgeBdyLoc3D::XLO_ZHI || edge_loc == EdgeBdyLoc3D::XHI_ZHI) {
   ...
   int node_btype)
{
   ...
   switch (node_btype) {
      ...
      case BdryCond::XNEUMANN:
      {
         if (node_loc == NodeBdyLoc3D::XLO_YLO_ZLO || NodeBdyLoc3D::XLO_YHI_ZLO ||
             NodeBdyLoc3D::XLO_YLO_ZHI || NodeBdyLoc3D::XLO_YHI_ZHI) {
            ret_face = BdryLoc::XLO;
         } else {
            ret_face = BdryLoc::XHI;
         }
      ...
      case BdryCond::YNEUMANN:
      {
         if (node_loc == NodeBdyLoc3D::XLO_YLO_ZLO || NodeBdyLoc3D::XHI_YLO_ZLO ||
   ...
   double bstate)
{
   ...
   if (btype == Bdry::FACE3D) {
      ...
      if (bcase == BdryCond::XFLOW || bcase == BdryCond::YFLOW || bcase == BdryCond::ZFLOW) {
         valfact = 1.0;
         constval = 0.0;
         dxfact = 0.0;
            ...
            if (!bdry_loc_db.isNull()) {
               if (bdry_loc_db->keyExists("boundary_condition")) {
                  ...
                  if (bdry_cond_str == "XFLOW" ||
                      ...
                      bdry_cond_str == "XNEUMANN" ||
                      bdry_cond_str == "XREFLECT") {
                     if (s == NodeBdyLoc3D::XLO_YLO_ZLO || s == NodeBdyLoc3D::XLO_YHI_ZLO ||
                         s == NodeBdyLoc3D::XLO_YLO_ZHI || s == NodeBdyLoc3D::XLO_YHI_ZHI) {
                        proper_face = "XLO";
                        if (bdry_cond_str == "XFLOW" &&
                            face_conds[BdryLoc::XLO] != BdryCond::FLOW) {
                           no_face_data_found = true;
                        ...
                        if (bdry_cond_str == "XREFLECT" &&
                           ...
                           proper_face_data = "REFLECT";
                             ...
                             bdry_cond_str == "YNEUMANN" ||
                             bdry_cond_str == "YREFLECT") {
                     if (s == NodeBdyLoc3D::XLO_YLO_ZLO || s == NodeBdyLoc3D::XHI_YLO_ZLO ||
                         s == NodeBdyLoc3D::XLO_YLO_ZHI || s == NodeBdyLoc3D::XHI_YLO_ZHI) {
                        proper_face = "YLO";
                        if (bdry_cond_str == "YFLOW" &&
                            face_conds[BdryLoc::YLO] != BdryCond::FLOW) {
                           no_face_data_found = true;
                        ...
                        if (bdry_cond_str == "YREFLECT" &&
                           ...
                           proper_face_data = "REFLECT";
                             ...
                             bdry_cond_str == "ZREFLECT") {
                     if (s == NodeBdyLoc3D::XLO_YLO_ZLO || s == NodeBdyLoc3D::XHI_YLO_ZLO ||
                         s == NodeBdyLoc3D::XLO_YHI_ZLO || s == NodeBdyLoc3D::XHI_YHI_ZLO) {
                        proper_face = "ZLO";
                        if (bdry_cond_str == "ZFLOW" &&
                            face_conds[BdryLoc::ZLO] != BdryCond::FLOW) {
                           no_face_data_found = true;
