   ...
   int node_btype)
{
   ...
   switch (node_btype) {
      ...
      {
         if (node_loc == NodeBdyLoc2D::XLO_YLO || node_loc == NodeBdyLoc2D::XLO_YHI) {
      ...
      {
         if (node_loc == NodeBdyLoc2D::XLO_YLO || node_loc == NodeBdyLoc2D::XHI_YLO) {
            ...
            if (bdry_loc_db) {
               if (bdry_loc_db->keyExists("boundary_condition")) {
                  ...
                  if (bdry_cond_str == "XFLOW" ||
                     ...
                     if (s == NodeBdyLoc2D::XLO_YLO || s == NodeBdyLoc2D::XLO_YHI) {
                        proper_edge = "XLO";
                        if (bdry_cond_str == "XFLOW" &&
                     ...
                     if (s == NodeBdyLoc2D::XLO_YLO || s == NodeBdyLoc2D::XHI_YLO) {
                        proper_edge = "YLO";
...
void SkeletonBoundaryUtilities2::stuff2dBdryFortConst()
{
   F77_FUNC(stufskelbdryloc2d, STUFSKELBDRYLOC2D) (
      ...
      NodeBdyLoc2D::XLO_YLO, NodeBdyLoc2D::XHI_YLO, NodeBdyLoc2D::XLO_YHI, NodeBdyLoc2D::XHI_YHI);
