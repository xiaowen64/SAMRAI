...
int main( int argc, char *argv[] )
{
    ...
    */
   {
	 ...
	 statistician->getStatistic("patchstat3", "PATCH_STAT");
      ...
      int myrank = tbox::SAMRAI_MPI::getRank();
      int i, j, ips;
	 ...
	 for (i = 0; i < tbox::SAMRAI_MPI::getNodes(); i++) {
	 ...
	 int num_patches = tbox::SAMRAI_MPI::getNodes()*2;
	 ...
	 if (!tbox::MathUtilities<double>::equalEps(statistician->getGlobalProcStatSum(
	 ...
	 double max0 = 0.;
	 double max1 = tbox::SAMRAI_MPI::getNodes();
	 double max2 = 2*(tbox::SAMRAI_MPI::getNodes());
	 if (!tbox::MathUtilities<double>::equalEps(statistician->getGlobalProcStatMax(
	 ...
	 if (statistician->getGlobalProcStatMaxProcessorId(
		procstat1->getInstanceId(), 1) != tbox::SAMRAI_MPI::getNodes()-1) {
	    fail_count++;
	 ...
	 if (statistician->getGlobalProcStatMaxProcessorId(
		procstat1->getInstanceId(), 2) != tbox::SAMRAI_MPI::getNodes()-1) {
	    fail_count++; 
	 ...
	 double min1 = 1.;
	 double min2 = 2.;
	 if (!tbox::MathUtilities<double>::equalEps(statistician->getGlobalProcStatMin(
	 ...
	 if (!tbox::MathUtilities<double>::equalEps(statistician->getGlobalPatchStatSum(
	 ...
	 if (!tbox::MathUtilities<double>::equalEps(statistician->getGlobalPatchStatMax(
	 ...
	 min0 = 0.;
	 min1 = 1.;
	 if (!tbox::MathUtilities<double>::equalEps(statistician->getGlobalPatchStatMin(
	 ...
	 int nnodes = tbox::SAMRAI_MPI::getNodes();
