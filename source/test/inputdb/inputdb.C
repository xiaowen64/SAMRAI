//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/test/inputdb/inputdb.C $
...
int main(int argc, char **argv)
{
...

   {
       ...
       *                        string, box
       *******************************************************************/
      tbox::Pointer<tbox::Database> prim_type_db = input_db->getDatabase("PrimitiveTypes");
	 ...
	 upper[i] = 9;
      ...
      tbox::DatabaseBox      box0_correct(NDIM,lower,upper);
	 ...
	 input_db->getDatabase("SmartArrays");
      ...
      tbox::Array<string>   s1_correct(5);
	 ...
	 box1_correct[i] = box0_correct;
      ...
      tbox::Array<string> s1   = smart_array_db->getStringArray("s1");
	 ...
	 input_db->getDatabase("PrimitiveTypes");
       ...
       ******************************************************************/
      tbox::plog << "Overall contents of input database..." << endl;
      input_db->printClassData(tbox::plog);

      tbox::plog << "\n\nUnused keys in the input database..." << endl;
      input_db->printUnusedKeys(tbox::plog);

      tbox::plog << "\n\nDefault keys in the input database..." << endl;
