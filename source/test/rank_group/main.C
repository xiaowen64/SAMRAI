   ...
   char* argv[])
{
...

   {
...

      {
         ...
         hier::ConnectorStatistics
         balance_anchor_stats(
            * balance_to_anchor);
   ...
   int tag_level_number)
{
   ...
   for (hier::PatchLevel::iterator pi(tag_level->begin());
      ...
      ciend(
         pdat::CellGeometry::end(tag_data->getGhostBox()));
