   ...
   char* argv[])
{
...

   {
       ...
       */
      boost::shared_ptr<tbox::SiloDatabaseFactory>
      silo_database_factory(
   ...
   Euler* euler_model)
{
   ...
   hier::BoxContainer
   domain(
      hierarchy->getGridGeometry()->getPhysicalDomain());
   hier::Box
   pencil_box(
