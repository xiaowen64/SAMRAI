//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/patchdata/operators/constant/node/NodeComplexInjection.h $
...
/**
 * Class NodeComplexInjection<DIM> implements constant
...
template<int DIM> class NodeComplexInjection
