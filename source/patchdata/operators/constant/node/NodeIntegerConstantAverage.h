//
// File:	NodeIntegerConstantAverage.h
...
#ifndef included_pdat_NodeIntegerConstantAverage
#define included_pdat_NodeIntegerConstantAverage
...
/**
 * Class NodeIntegerConstantAverage<DIM> implements constant
...
template<int DIM> class NodeIntegerConstantAverage 
...
public:
    ...
    */
   virtual ~NodeIntegerConstantAverage<DIM>();
...
#include "NodeIntegerConstantAverage.C"
#endif
