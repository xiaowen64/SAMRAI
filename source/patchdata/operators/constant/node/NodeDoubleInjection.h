//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/patchdata/operators/constant/node/NodeDoubleInjection.h $
...
/**
 * Class NodeDoubleInjection<DIM> implements constant
...
template<int DIM> class NodeDoubleInjection
