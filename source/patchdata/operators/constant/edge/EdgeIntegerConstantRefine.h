//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/patchdata/operators/constant/edge/EdgeIntegerConstantRefine.h $
...
/**
 * Class EdgeIntegerConstantRefine<DIM> implements constant
...
template<int DIM> class EdgeIntegerConstantRefine 
...
public:
    ...
    * component on the fine patch using the edge-centered integer constant
