//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/patchdata/operators/constant/edge/EdgeComplexConstantRefine.C $
   ...
   const hier::IntVector<DIM>& ratio) const
{
   ...
   for (int d = 0; d < fdata->getDepth(); d++) {
	 ...
	 TBOX_ERROR("EdgeComplexConstanRefine::refine DIM > 3 not supported" << std::endl);
      }
   }
}
