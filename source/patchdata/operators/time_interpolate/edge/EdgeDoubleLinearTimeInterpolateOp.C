//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/patchdata/operators/time_interpolate/edge/EdgeDoubleLinearTimeInterpolateOp.C $
...
extern "C" {
// in lintimint1d.f:
   void lintimeintedgedoub1d_( const int&, const int&,
                               const int&, const int&,
                               const int&, const int&,
                               const int&, const int&,
                               const double&,
                               ...
                               double* );
// in lintimint2d.f:
   void lintimeintedgedoub2d0_( const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                ...
                                const double*, const double*,
                                double* );
   void lintimeintedgedoub2d1_( const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                const int&, const int&,
                                ...
                                double* );
// in lintimint3d.f:
   void lintimeintedgedoub3d0_( const int&, const int&, const int&,
                                ...
                                const double*, const double*,
                                double* );
   void lintimeintedgedoub3d1_( const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                ...
                                const double*, const double*,
                                double* );
   void lintimeintedgedoub3d2_( const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
                                const int&, const int&, const int&,
...
template<int DIM> EdgeDoubleLinearTimeInterpolateOp<DIM>::EdgeDoubleLinearTimeInterpolateOp()
...
template<int DIM> bool EdgeDoubleLinearTimeInterpolateOp<DIM>::findTimeInterpolateOperator(
   const tbox::Pointer< hier::Variable<DIM> >& var,
   const std::string &op_name) const
{
   const tbox::Pointer< EdgeVariable<DIM,double> > cast_var(var);
...
template<int DIM> void EdgeDoubleLinearTimeInterpolateOp<DIM>::timeInterpolate(
   ...
   const hier::PatchData<DIM>& src_data_new) const
{
   ...
   const EdgeData<DIM,double> *old_dat =
      dynamic_cast<const EdgeData<DIM,double> *>(&src_data_old);
   const EdgeData<DIM,double> *new_dat =
      dynamic_cast<const EdgeData<DIM,double> *>(&src_data_new);
   EdgeData<DIM,double> *dst_dat = 
      dynamic_cast<EdgeData<DIM,double> *>(&dst_data);
   ...
   for (int d = 0; d < dst_dat->getDepth(); d++) {
      if (DIM == 1) {
	 lintimeintedgedoub1d_(ifirst(0),ilast(0),
			       old_ilo(0),old_ihi(0),
			       new_ilo(0),new_ihi(0),
			       dst_ilo(0),dst_ihi(0),
			       tfrac,
	 ...
	 lintimeintedgedoub2d0_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				...
				new_dat->getPointer(0,d),
				dst_dat->getPointer(0,d));
	 lintimeintedgedoub2d1_(ifirst(0),ifirst(1),ilast(0),ilast(1),
				old_ilo(0),old_ilo(1),old_ihi(0),old_ihi(1),
				new_ilo(0),new_ilo(1),new_ihi(0),new_ihi(1),
				dst_ilo(0),dst_ilo(1),dst_ihi(0),dst_ihi(1),
				tfrac,
	 ...
	 lintimeintedgedoub3d0_(ifirst(0),ifirst(1),ifirst(2),
				...
				new_dat->getPointer(0,d),
				dst_dat->getPointer(0,d));
	 lintimeintedgedoub3d1_(ifirst(0),ifirst(1),ifirst(2),
				ilast(0),ilast(1),ilast(2),
				old_ilo(0),old_ilo(1),old_ilo(2),
				old_ihi(0),old_ihi(1),old_ihi(2),
				new_ilo(0),new_ilo(1),new_ilo(2),
				...
				new_dat->getPointer(1,d),
				dst_dat->getPointer(1,d));
	 lintimeintedgedoub3d2_(ifirst(0),ifirst(1),ifirst(2),
				ilast(0),ilast(1),ilast(2),
				old_ilo(0),old_ilo(1),old_ilo(2),
				old_ihi(0),old_ihi(1),old_ihi(2),
				new_ilo(0),new_ilo(1),new_ilo(2),
	 ...
	 TBOX_ERROR("EdgeDoubleLinearTimeInterpolateOp::TimeInterpolate DIM > 3 not supported" << std::endl);
      }
   }
}
