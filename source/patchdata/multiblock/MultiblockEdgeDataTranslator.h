//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/trunk/source/patchdata/boxgeometry/MultiblockEdgeDataTranslator.h $
...
template<int DIM, class TYPE> class MultiblockEdgeDataTranslator :
