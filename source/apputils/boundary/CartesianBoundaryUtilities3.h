//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/apputils/boundary/CartesianBoundaryUtilities3.h $
...
public:
    ...
    */
   static int getFaceLocationForEdgeBdry(
      int edge_loc,
      int edge_btype);
    ...
    */
   static int getFaceLocationForNodeBdry(
      int node_loc,
      int node_btype);
...
private:
   ...
   static void read3dBdryFaces(BoundaryUtilityStrategy* bdry_strategy,
                               tbox::Pointer<tbox::Database> bdry_db,
                               tbox::Array<int>& face_conds,
                               const hier::IntVector<3>& periodic);

   static void read3dBdryEdges(tbox::Pointer<tbox::Database> bdry_db,
                               const tbox::Array<int>& face_conds,
                               tbox::Array<int>& edge_conds,
                               const hier::IntVector<3>& periodic);

   static void read3dBdryNodes(tbox::Pointer<tbox::Database> bdry_db,
                               const tbox::Array<int>& face_conds,
                               tbox::Array<int>& node_conds,
                               const hier::IntVector<3>& periodic);

   static void get3dBdryDirectionCheckValues(int& idir, 
                                             int& offsign,
                                             int btype, 
                                             int bloc,
                                             int bcase);
