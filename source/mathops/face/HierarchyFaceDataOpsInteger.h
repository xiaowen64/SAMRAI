//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/face/HierarchyFaceDataOpsInteger.h $
...
/**
 * Class HierarchyFaceDataOpsInteger<DIM> provides a collection of 
 ...
 * operations are performed by the PatchFaceDataOpsInteger<DIM> data member.
 *
 ...
 * HierarchyFaceDataOpsReal<DIM> and HierarchyFaceDataOpsComplex<DIM>, 
 * respectively.
 * 
...
template<int DIM>
class HierarchyFaceDataOpsInteger : public HierarchyDataOpsInteger<DIM>
{
public:
   /**
    * The constructor for the HierarchyFaceDataOpsInteger<DIM> class sets
...
private:
   ...
   HierarchyFaceDataOpsInteger(const HierarchyFaceDataOpsInteger<DIM>&);
   void operator=(const HierarchyFaceDataOpsInteger<DIM>&);
   ...
   PatchFaceDataOpsInteger<DIM> d_patch_ops;
