//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/node/HierarchyNodeDataOpsInteger.h $
...
/**
 * Class HierarchyNodeDataOpsInteger<DIM> provides a collection of 
 ...
 * operations are performed by the PatchNodeDataOpsInteger<DIM> data member.
 *
 ...
 * HierarchyNodeDataOpsReal<DIM> and HierarchyNodeDataOpsComplex<DIM>, 
 * respectively.
 * 
 * @see math::PatchNodeDataOpsInteger
 */

template<int DIM> class HierarchyNodeDataOpsInteger : public HierarchyDataOpsInteger<DIM>
{
public:
   /**
    * The constructor for the HierarchyNodeDataOpsInteger<DIM> class sets
