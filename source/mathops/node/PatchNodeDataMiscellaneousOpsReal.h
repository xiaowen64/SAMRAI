//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/mathops/node/PatchNodeDataMiscellaneousOpsReal.h $
...
private:
   ...
   PatchNodeDataMiscellaneousOpsReal(
      const PatchNodeDataMiscellaneousOpsReal<DIM,TYPE>&);
