//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/mathops/node/HierarchyNodeDataOpsComplex.h $
...
/**
 * Class HierarchyNodeDataOpsComplex<DIM> provides a collection of 
 ...
 * PatchNodeDataOpsComplex<DIM> data member.
 *
 ...
 * HierarchyNodeDataOpsReal<DIM> and HierarchyNodeDataOpsInteger<DIM>, 
 * respectively.
 * 
 * @see math::PatchNodeDataOpsComplex
 */

template<int DIM> class HierarchyNodeDataOpsComplex : public HierarchyDataOpsComplex<DIM>
{
public:
   /**
    * The constructor for the HierarchyNodeDataOpsComplex<DIM> class sets
...
private:
   ...
   HierarchyNodeDataOpsComplex(const HierarchyNodeDataOpsComplex<DIM>&);
   void operator=(const HierarchyNodeDataOpsComplex<DIM>&);
