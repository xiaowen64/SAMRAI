//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/side/HierarchySideDataOpsComplex.h $
...
/**
 * Class HierarchySideDataOpsComplex<DIM> provides a collection of 
 ...
 * PatchSideDataOpsComplex<DIM> data member.
 *
 ...
 * HierarchySideDataOpsReal<DIM> and HierarchySideDataOpsInteger<DIM>, 
 * respectively.
 * 
...
template<int DIM>
class HierarchySideDataOpsComplex : public HierarchyDataOpsComplex<DIM>
{
public:
   /**
    * The constructor for the HierarchySideDataOpsComplex<DIM> class sets
...
private:
   ...
   HierarchySideDataOpsComplex(const HierarchySideDataOpsComplex<DIM>&);
   void operator=(const HierarchySideDataOpsComplex<DIM>&);
