//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/side/HierarchySideDataOpsInteger.h $
...
/**
 * Class HierarchySideDataOpsInteger<DIM> provides a collection of 
 ...
 * operations are performed by the PatchSideDataOpsInteger<DIM> data member.
 *
 ...
 * HierarchySideDataOpsReal<DIM> and HierarchySideDataOpsComplex<DIM>, 
 * respectively.
 * 
...
template<int DIM>
class HierarchySideDataOpsInteger : public HierarchyDataOpsInteger<DIM>
{
public:
   /**
    * The constructor for the HierarchySideDataOpsInteger<DIM> class sets
...
private:
   ...
   HierarchySideDataOpsInteger(const HierarchySideDataOpsInteger<DIM>&);
   void operator=(const HierarchySideDataOpsInteger<DIM>&);
