//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/mathops/hierarchy/HierarchyDataOpsComplex.h $
...
/**
 * Class HierarchyDataOpsComplex<DIM> defines the interface to a collection 
 ...
 * classes HierarchyDataOpsReal<DIM> and HierarchyDataOpsInteger<DIM>, 
 * respectively.
 */
...
public:
    ...
    * the summation.
    */
   virtual dcomplex dot(const int data1_id,
                    const int data2_id, 
                    const int vol_id = -1) const = 0;

private:
   // The following are not implemented
   HierarchyDataOpsComplex(const HierarchyDataOpsComplex<DIM>&);
   void operator=(const HierarchyDataOpsComplex<DIM>&);
...
#include "HierarchyDataOpsComplex.C"
#endif
