//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/hierarchy/HierarchyDataOpsManager.h $
...
/**
 * Class HierarchyDataOpsManager<DIM> is a Singleton class that serves as
...
public:
    ...
    * manager.  All access to the HierarchyDataOpsManager<DIM> object is 
    ...
    * HierarchyDataOpsManager<DIM>::getManager()->getOperationsDouble(
    *                                               var, hierarchy),
   ...
   */
   virtual tbox::Pointer< HierarchyDataOpsReal<DIM,double> > 
   getOperationsDouble
   ...
   /*!
     ...
     on the given hierarchy.
   */
   virtual tbox::Pointer< HierarchyDataOpsReal<DIM,float> > 
   getOperationsFloat
   ( /*! operation should correspond to this variable */
     const tbox::Pointer< hier::Variable<DIM> >& variable
   , /*! operation should correspond to this hierarchy */
   ...
   /*!
     ...
     on the given hierarchy.
   */
   virtual tbox::Pointer< HierarchyDataOpsComplex<DIM> > 
   ...
   /*!
     ...
     on the given hierarchy.
   */
   virtual tbox::Pointer< HierarchyDataOpsInteger<DIM> > 
...
private:
   ...
   tbox::Array< tbox::Pointer< HierarchyDataOpsReal<DIM,double> > > 
      d_cell_ops_double;
   tbox::Array< tbox::Pointer< HierarchyDataOpsReal<DIM,double> > >
      d_face_ops_double;
   tbox::Array< tbox::Pointer< HierarchyDataOpsReal<DIM,double> > >
...
#ifdef HAVE_FLOAT
   tbox::Array< tbox::Pointer< HierarchyDataOpsReal<DIM,float> > >
      d_cell_ops_float;
   tbox::Array< tbox::Pointer< HierarchyDataOpsReal<DIM,float> > >
      d_face_ops_float;
   tbox::Array< tbox::Pointer< HierarchyDataOpsReal<DIM,float> > >
...
#ifdef HAVE_DCOMPLEX
   tbox::Array< tbox::Pointer< HierarchyDataOpsComplex<DIM> > >
      d_cell_ops_complex;
   tbox::Array< tbox::Pointer< HierarchyDataOpsComplex<DIM> > >
      d_face_ops_complex;
   tbox::Array< tbox::Pointer< HierarchyDataOpsComplex<DIM> > >
   ...
   tbox::Array< tbox::Pointer< HierarchyDataOpsInteger<DIM> > >
      d_cell_ops_int;
   tbox::Array< tbox::Pointer< HierarchyDataOpsInteger<DIM> > >
      d_face_ops_int;
   tbox::Array< tbox::Pointer< HierarchyDataOpsInteger<DIM> > >
...
#include "HierarchyDataOpsManager.C"
#endif
