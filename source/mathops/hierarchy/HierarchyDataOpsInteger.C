//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/mathops/hierarchy/HierarchyDataOpsInteger.C $
...
template<int DIM>  HierarchyDataOpsInteger<DIM>::HierarchyDataOpsInteger()
{
}
