//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/mathops/edge/HierarchyEdgeDataOpsInteger.h $
...
/**
 * Class HierarchyEdgeDataOpsInteger<DIM> provides a collection of 
 ...
 * operations are performed by the PatchEdgeDataOpsInteger<DIM> data member.
 *
 ...
 * HierarchyEdgeDataOpsReal<DIM> and HierarchyEdgeDataOpsComplex<DIM>, 
 * respectively.
 * 
...
template<int DIM>
class HierarchyEdgeDataOpsInteger : public HierarchyDataOpsInteger<DIM>
{
public:
   /**
    * The constructor for the HierarchyEdgeDataOpsInteger<DIM> class sets
...
private:
   ...
   HierarchyEdgeDataOpsInteger(const HierarchyEdgeDataOpsInteger<DIM>&);
   void operator=(const HierarchyEdgeDataOpsInteger<DIM>&);
