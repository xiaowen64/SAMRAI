//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-3-0/source/geometry/cartesian/operators/cell/CartesianCellDoubleWeightedAverage.C $
...
template<int DIM> CartesianCellDoubleWeightedAverage<DIM>::CartesianCellDoubleWeightedAverage()
...
template<int DIM> bool CartesianCellDoubleWeightedAverage<DIM>::findCoarsenOperator(
...
CartesianCellDoubleWeightedAverage<DIM>::getOperatorName() const
{
   return(d_name_id);
}

template<int DIM> int CartesianCellDoubleWeightedAverage<DIM>::getOperatorPriority() const
{
   return(0);
}

template<int DIM> hier::IntVector<DIM> 
CartesianCellDoubleWeightedAverage<DIM>::getStencilWidth() const {
   return(hier::IntVector<DIM>(0));
}

template<int DIM> void CartesianCellDoubleWeightedAverage<DIM>::coarsen(
