//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/geometry/cartesian/operators/face/CartesianFaceFloatWeightedAverage.h $
 ...
 * variable is face-centered float, and the string is "CONSERVATIVE_COARSEN".
 * 
 * @see xfer::CoarsenOperator
 */

template<int DIM> class CartesianFaceFloatWeightedAverage 
