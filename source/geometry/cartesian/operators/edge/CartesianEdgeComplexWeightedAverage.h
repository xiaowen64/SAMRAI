//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/geometry/cartesian/operators/edge/CartesianEdgeComplexWeightedAverage.h $
 ...
 * variable is edge-centered complex, and the string is "CONSERVATIVE_COARSEN".
 * 
 * @see xfer::CoarsenOperator
 */

template<int DIM> class CartesianEdgeComplexWeightedAverage 
