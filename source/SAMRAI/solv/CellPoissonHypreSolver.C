...
CellPoissonHypreSolver::s_finalize_handler(
   0,
   0,
   0,
   ...
   const PoissonSpecifications& spec)
{
   ...
   for (hier::PatchLevel::iterator pi(level->begin());
      ...
      pdat::CellIterator
      icend(
         pdat::CellGeometry::end(patch_box));
