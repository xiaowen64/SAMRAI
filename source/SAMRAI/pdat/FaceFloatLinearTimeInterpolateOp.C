...
void
SAMRAI_F77_FUNC(
   lintimeintfacefloat1d,
   LINTIMEINTFACEFLOAT1D) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintfacefloat2d0,
   LINTIMEINTFACEFLOAT2D0) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintfacefloat2d1,
   LINTIMEINTFACEFLOAT2D1) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintfacefloat3d0,
   LINTIMEINTFACEFLOAT3D0) (const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintfacefloat3d1,
   LINTIMEINTFACEFLOAT3D1) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintfacefloat3d2,
   LINTIMEINTFACEFLOAT3D2) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
