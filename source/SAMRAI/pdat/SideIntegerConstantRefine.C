...
SAMRAI_F77_FUNC(
   conrefsideintg1d,
   CONREFSIDEINTG1D) (const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   const int *,
...
SAMRAI_F77_FUNC(
   conrefsideintg2d0,
   CONREFSIDEINTG2D0) (const int&, const int&,
   const int&, const int&,
...
SAMRAI_F77_FUNC(
   conrefsideintg2d1,
   CONREFSIDEINTG2D1) (const int&, const int&,
   const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
...
SAMRAI_F77_FUNC(
   conrefsideintg3d0,
   CONREFSIDEINTG3D0) (const int&, const int&,
   const int&,
...
SAMRAI_F77_FUNC(
   conrefsideintg3d1,
   CONREFSIDEINTG3D1) (const int&, const int&,
   const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
SAMRAI_F77_FUNC(
   conrefsideintg3d2,
   CONREFSIDEINTG3D2) (const int&, const int&,
   const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
