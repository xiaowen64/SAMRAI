...
void
SAMRAI_F77_FUNC(
   lintimeintedgedoub1d,
   LINTIMEINTEDGEDOUB1D) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintedgedoub2d0,
   LINTIMEINTEDGEDOUB2D0) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintedgedoub2d1,
   LINTIMEINTEDGEDOUB2D1) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintedgedoub3d0,
   LINTIMEINTEDGEDOUB3D0) (const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintedgedoub3d1,
   LINTIMEINTEDGEDOUB3D1) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintedgedoub3d2,
   LINTIMEINTEDGEDOUB3D2) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
