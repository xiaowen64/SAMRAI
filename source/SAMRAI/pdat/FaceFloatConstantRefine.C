...
SAMRAI_F77_FUNC(
   conreffaceflot1d,
   CONREFFACEFLOT1D) (const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   const int *,
...
SAMRAI_F77_FUNC(
   conreffaceflot2d0,
   CONREFFACEFLOT2D0) (const int&, const int&,
   const int&, const int&,
...
SAMRAI_F77_FUNC(
   conreffaceflot2d1,
   CONREFFACEFLOT2D1) (const int&, const int&,
   const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
...
SAMRAI_F77_FUNC(
   conreffaceflot3d0,
   CONREFFACEFLOT3D0) (const int&, const int&,
   const int&,
...
SAMRAI_F77_FUNC(
   conreffaceflot3d1,
   CONREFFACEFLOT3D1) (const int&, const int&,
   const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
SAMRAI_F77_FUNC(
   conreffaceflot3d2,
   CONREFFACEFLOT3D2) (const int&, const int&,
   const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   ...
   const hier::IntVector& ratio) const
{
   ...
   boost::shared_ptr<FaceData<float> >
   cdata(
