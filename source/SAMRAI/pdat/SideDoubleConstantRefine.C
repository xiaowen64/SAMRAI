...
SAMRAI_F77_FUNC(
   conrefsidedoub1d,
   CONREFSIDEDOUB1D) (const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   const int *,
...
SAMRAI_F77_FUNC(
   conrefsidedoub2d0,
   CONREFSIDEDOUB2D0) (const int&, const int&,
   const int&, const int&,
...
SAMRAI_F77_FUNC(
   conrefsidedoub2d1,
   CONREFSIDEDOUB2D1) (const int&, const int&,
   const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
...
SAMRAI_F77_FUNC(
   conrefsidedoub3d0,
   CONREFSIDEDOUB3D0) (const int&, const int&,
   const int&,
...
SAMRAI_F77_FUNC(
   conrefsidedoub3d1,
   CONREFSIDEDOUB3D1) (const int&, const int&,
   const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
SAMRAI_F77_FUNC(
   conrefsidedoub3d2,
   CONREFSIDEDOUB3D2) (const int&, const int&,
   const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
