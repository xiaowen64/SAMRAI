...
void
SAMRAI_F77_FUNC(
   lintimeintfacedoub1d,
   LINTIMEINTFACEDOUB1D) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintfacedoub2d0,
   LINTIMEINTFACEDOUB2D0) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintfacedoub2d1,
   LINTIMEINTFACEDOUB2D1) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintfacedoub3d0,
   LINTIMEINTFACEDOUB3D0) (const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintfacedoub3d1,
   LINTIMEINTFACEDOUB3D1) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   lintimeintfacedoub3d2,
   LINTIMEINTFACEDOUB3D2) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
