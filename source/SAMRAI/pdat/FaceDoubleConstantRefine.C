...
SAMRAI_F77_FUNC(
   conreffacedoub1d,
   CONREFFACEDOUB1D) (const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   const int *,
...
SAMRAI_F77_FUNC(
   conreffacedoub2d0,
   CONREFFACEDOUB2D0) (const int&, const int&,
   const int&, const int&,
...
SAMRAI_F77_FUNC(
   conreffacedoub2d1,
   CONREFFACEDOUB2D1) (const int&, const int&,
   const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
...
SAMRAI_F77_FUNC(
   conreffacedoub3d0,
   CONREFFACEDOUB3D0) (const int&, const int&,
   const int&,
...
SAMRAI_F77_FUNC(
   conreffacedoub3d1,
   CONREFFACEDOUB3D1) (const int&, const int&,
   const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
SAMRAI_F77_FUNC(
   conreffacedoub3d2,
   CONREFFACEDOUB3D2) (const int&, const int&,
   const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
