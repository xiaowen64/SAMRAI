...
void
SAMRAI_F77_FUNC(
   lintimeintoutsidecmplx1d,
   LINTIMEINTOUTSIDECMPLX1D) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
