...
void
SAMRAI_F77_FUNC(
   conrefoutfaceintg2d0,
   CONREFOUTFACEINTG2D0) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   conrefoutfaceintg2d1,
   CONREFOUTFACEINTG2D1) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   conrefoutfaceintg3d0,
   CONREFOUTFACEINTG3D0) (const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   conrefoutfaceintg3d1,
   CONREFOUTFACEINTG3D1) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   conrefoutfaceintg3d2,
   CONREFOUTFACEINTG3D2) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   ...
   const hier::IntVector& ratio) const
{
   ...
   boost::shared_ptr<OuterfaceData<int> >
   cdata(
