...
void
SAMRAI_F77_FUNC(
   conrefoutfaceflot2d0,
   CONREFOUTFACEFLOT2D0) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   conrefoutfaceflot2d1,
   CONREFOUTFACEFLOT2D1) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   conrefoutfaceflot3d0,
   CONREFOUTFACEFLOT3D0) (const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   conrefoutfaceflot3d1,
   CONREFOUTFACEFLOT3D1) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   conrefoutfaceflot3d2,
   CONREFOUTFACEFLOT3D2) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   ...
   const hier::IntVector& ratio) const
{
   ...
   boost::shared_ptr<OuterfaceData<float> >
   cdata(
