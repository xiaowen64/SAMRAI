...
SAMRAI_F77_FUNC(
   ...
   CARTLINREFCELLDOUB1D) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   cartlinrefcelldoub2d,
   CARTLINREFCELLDOUB2D) (const int&,
...
void
SAMRAI_F77_FUNC(
   cartlinrefcelldoub3d,
   CARTLINREFCELLDOUB3D) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
int
CartesianCellDoubleLinearRefine::getOperatorPriority() const
{
   return 0;
}
...
void
CartesianCellDoubleLinearRefine::refine(
   hier::Patch& fine,
