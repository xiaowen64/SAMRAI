...
void
SAMRAI_F77_FUNC(
   cartwgtavgedgecplx1d,
   CARTWGTAVGEDGECPLX1D) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   cartwgtavgedgecplx2d0,
   CARTWGTAVGEDGECPLX2D0) (const int&,
...
void
SAMRAI_F77_FUNC(
   cartwgtavgedgecplx2d1,
   CARTWGTAVGEDGECPLX2D1) (const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int *, const double *, const double *,
...
void
SAMRAI_F77_FUNC(
   cartwgtavgedgecplx3d0,
   CARTWGTAVGEDGECPLX3D0) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   cartwgtavgedgecplx3d1,
   CARTWGTAVGEDGECPLX3D1) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   cartwgtavgedgecplx3d2,
   CARTWGTAVGEDGECPLX3D2) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   ...
   const hier::IntVector& ratio) const
{
   ...
   boost::shared_ptr<pdat::EdgeData<dcomplex> >
   fdata(
