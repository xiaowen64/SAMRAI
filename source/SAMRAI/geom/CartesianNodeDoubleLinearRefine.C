...
void
SAMRAI_F77_FUNC(
   cartlinrefnodedoub1d,
   CARTLINREFNODEDOUB1D) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   cartlinrefnodedoub2d,
   CARTLINREFNODEDOUB2D) (const int&,
...
void
SAMRAI_F77_FUNC(
   cartlinrefnodedoub3d,
   CARTLINREFNODEDOUB3D) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
