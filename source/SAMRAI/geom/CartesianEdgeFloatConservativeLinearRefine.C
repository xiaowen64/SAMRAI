...
void
SAMRAI_F77_FUNC(
   cartclinrefedgeflot1d,
   CARTCLINREFEDGEFLOT1D) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   cartclinrefedgeflot2d0,
   CARTCLINREFEDGEFLOT2D0) (const int&,
...
void
SAMRAI_F77_FUNC(
   cartclinrefedgeflot2d1,
   CARTCLINREFEDGEFLOT2D1) (const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
   const int&, const int&, const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   cartclinrefedgeflot3d0,
   CARTCLINREFEDGEFLOT3D0) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   cartclinrefedgeflot3d1,
   CARTCLINREFEDGEFLOT3D1) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
void
SAMRAI_F77_FUNC(
   cartclinrefedgeflot3d2,
   CARTCLINREFEDGEFLOT3D2) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   ...
   const hier::IntVector& ratio) const
{
   ...
   boost::shared_ptr<pdat::EdgeData<float> >
   cdata(
      BOOST_CAST<pdat::EdgeData<float>, hier::PatchData>(
