...
public:
    ...
    * @pre coarse.getPatchData(src_component) is actually a boost::shared_ptr<pdat::EdgeData<float> >
    * @pre fine.getPatchData(dst_component) is actually a boost::shared_ptr<pdat::EdgeData<float> >
