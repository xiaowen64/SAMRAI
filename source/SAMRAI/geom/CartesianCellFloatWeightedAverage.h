...
public:
    ...
    * @pre fine.getPatchData(src_component) is actually a boost::shared_ptr<pdat::CellData<float> >
    * @pre coarse.getPatchData(dst_component) is actually a boost::shared_ptr<pdat::CellData<float> >
