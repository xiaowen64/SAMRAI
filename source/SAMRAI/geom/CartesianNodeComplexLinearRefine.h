...
public:
    ...
    * @pre coarse.getPatchData(src_component) is actually a boost::shared_ptr<pdat::NodeData<dcomplex> >
    * @pre fine.getPatchData(dst_component) is actually a boost::shared_ptr<pdat::NodeData<dcomplex> >
