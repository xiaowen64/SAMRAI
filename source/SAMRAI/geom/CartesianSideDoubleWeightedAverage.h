...
public:
    ...
    * @pre fine.getPatchData(src_component) is actually a boost::shared_ptr<pdat::SideData<double> >
    * @pre coarse.getPatchData(dst_component) is actually a boost::shared_ptr<pdat::SideData<double> >
