...
public:
    ...
    * @pre fine.getPatchData(src_component) is actually a boost::shared_ptr<pdat::FaceData<float> >
    * @pre coarse.getPatchData(dst_component) is actually a boost::shared_ptr<pdat::FaceData<float> >
