...
public:
    ...
    *
    * @pre patch
    * @pre patch->getPatchData(data1_id) is actually a boost::shared_ptr<pdat::NodeData<TYPE> >
    * @pre patch->getPatchData(data2_id) is actually a boost::shared_ptr<pdat::NodeData<TYPE> >
