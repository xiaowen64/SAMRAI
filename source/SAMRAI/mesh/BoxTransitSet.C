...
const std::string
BoxTransitSet::s_default_timer_prefix(
   "mesh::BoxTransitSet");
   ...
   const tbox::SAMRAI_MPI& mpi) const
{
   ...
   BoxInTransit
   balanced_box_in_transit(
      unbalanced_box_level.getDim());
   ...
   LoadType high_load)
{
   ...
   BoxTransitSet&
   hold_bin(
      recastTransitLoad(transit_load_hold_bin));
   ...
   LoadType high_load)
{
   ...
   BoxInTransit
   breakbox(
      d_pparams->getMinBoxSize().getDim());
