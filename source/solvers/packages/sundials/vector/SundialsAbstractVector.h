//
// File:        $URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/solvers/packages/sundials/vector/SundialsAbstractVector.h $
...
public:
    ...
    * x is another vector.
    */
   virtual void scaleVector(const SundialsAbstractVector* x,
                            const double c) = 0;
    ...
    */
   virtual void pointwiseMultiply(const SundialsAbstractVector* x,
                                  const SundialsAbstractVector* y) = 0;
    ...
    */
   virtual void pointwiseDivide(const SundialsAbstractVector* x,
                                const SundialsAbstractVector* y) = 0;
    ...
    */
   virtual void addScalar(const SundialsAbstractVector* x,
                          const double b) = 0;
    ...
    */
   virtual void compareToScalar(const SundialsAbstractVector* x,
                                const double c) = 0;
  ...
  private:
    ...
    * 
    */
   static N_Vector_Ops createVectorOps();
...
//   static N_Vector N_VCloneEmpty_SAMRAI(N_Vector w);
   static N_Vector N_VClone_SAMRAI(N_Vector w);
   static void N_VDestroy_SAMRAI(N_Vector v);
...
// static void N_VSetArrayPointer_SAMRAI(realtype *v_data, N_Vector v);
   static void N_VLinearSum_SAMRAI(realtype a, N_Vector x, realtype b, N_Vector y, N_Vector z);
   static void N_VConst_SAMRAI(realtype c, N_Vector z);
   static void N_VProd_SAMRAI(N_Vector x, N_Vector y, N_Vector z);
   static void N_VDiv_SAMRAI(N_Vector x, N_Vector y, N_Vector z);
   static void N_VScale_SAMRAI(realtype c, N_Vector x, N_Vector z);
   static void N_VAbs_SAMRAI(N_Vector x, N_Vector z);
   static void N_VInv_SAMRAI(N_Vector x, N_Vector z);
   static void N_VAddConst_SAMRAI(N_Vector x, realtype b, N_Vector z);
   static realtype N_VDotProd_SAMRAI(N_Vector x, N_Vector y);
   static realtype N_VMaxNorm_SAMRAI(N_Vector x);
   static realtype N_VWrmsNorm_SAMRAI(N_Vector x, N_Vector w);
// static realtype N_VWrmsNormMask_SAMRAI(N_Vector x, N_Vector w, N_Vector id);
   static realtype N_VMin_SAMRAI(N_Vector x);
   static realtype N_VWL2Norm_SAMRAI(N_Vector x, N_Vector w);
   static realtype N_VL1Norm_SAMRAI(N_Vector x);
   static void N_VCompare_SAMRAI(realtype c, N_Vector x, N_Vector z);
   static booleantype N_VInvTest_SAMRAI(N_Vector x, N_Vector z);
