...
public:
    ...
    */
   virtual void evaluateNonlinearFunction(SundialsAbstractVector* soln,
    ...
    */
   virtual int precondSetup(SundialsAbstractVector* soln,
    ...
    *            vectors.
    */
   virtual int precondSolve(SundialsAbstractVector* soln,
                            SundialsAbstractVector* soln_scale,
                            SundialsAbstractVector* fval,
                            SundialsAbstractVector* fval_scale,
    ...
    */
   virtual int jacobianTimesVector(SundialsAbstractVector* vector,
