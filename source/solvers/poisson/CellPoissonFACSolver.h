 ...
 * -# Construct a CellPoissonFACSolver<DIM> object, providing it
 ...
 *
 */
template<int DIM> class CellPoissonFACSolver
{
...
public:
    ...
    * @return whether solver converged to specified level
    *
    * @see solveSystem( const int, const int, tbox::Pointer< hier::PatchHierarchy<DIM> >, int, int);
    */
    ...
    *
    * This method is used to set up the default SimpleCellRobinBcCoefs<DIM>
    ...
    * of the SimpleCellRobinBcCoefs<DIM> class or you prefer to
    * use your own implementation.
    *
    * Note that an important limitation of the SimpleCellRobinBcCoefs<DIM>
...
private:
   ...
   /*
    * @brief Default implementation of RobinBcCoefStrategy<DIM>
    */
