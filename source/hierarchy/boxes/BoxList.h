//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-0/source/hierarchy/boxes/BoxList.h $
...
public:
    ...
    * function merely calls the getNumberItems() function in the tbox::List
