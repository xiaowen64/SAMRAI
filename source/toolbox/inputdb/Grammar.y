%{
//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-2-1/source/toolbox/inputdb/Grammar.y $
      ...
      switch($1->d_array_type) {
         ...
         case KEY_BOX:
            if ($3->d_node_type != KEY_BOX) {
               ...
               delete $3;
               $$ = $1;
            } else if ($3->d_box.getDimension() != $1->d_box.getDimension()) {
