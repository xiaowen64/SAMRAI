...
std::string nameMangle(std::string name) {
   std::string str(name);
...
std::string nameDemangle(std::string name) {
   std::string str(name);
   std::string::size_type pos = 0;
...
bool SiloDatabase::create(const std::string& name) {
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!name.empty());
#endif
...
bool SiloDatabase::open(const std::string& name) {
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!name.empty());
#endif
...
*************************************************************************
*/
bool SiloDatabase::attachToFile(DBfile *file, const std::string &directory)
{
   bool status = false;
...
bool SiloDatabase::keyExists(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
...
*************************************************************************
*/
enum Database::DataType SiloDatabase::getArrayType(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
int SiloDatabase::getArraySize(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::isDatabase(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::isBool(const std::string& key)
{
...
Array<bool> SiloDatabase::getBoolArray(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::isDatabaseBox(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
Array<DatabaseBox> SiloDatabase::getDatabaseBoxArray(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::isChar(const std::string& key)
{
...
Array<char> SiloDatabase::getCharArray(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::isComplex(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
Array<dcomplex> SiloDatabase::getComplexArray(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::isDouble(const std::string& key)
{
...
Array<double> SiloDatabase::getDoubleArray(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::isFloat(const std::string& key)
{
...
Array<float> SiloDatabase::getFloatArray(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::isInteger(const std::string& key)
{
...
Array<int> SiloDatabase::getIntegerArray(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::isString(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
Array<std::string> SiloDatabase::getStringArray(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
void SiloDatabase::printClassData(std::ostream& os)
{
...
bool SiloDatabase::isSiloType(const std::string& key, DBObjectType type)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::isSiloSimpleType(const std::string& key, const int simple_type)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
bool SiloDatabase::putSiloSimpleType(const std::string& key, const void *data, const int nelements, const int simple_type)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
   TBOX_ASSERT(data != (float*)NULL);
...
bool SiloDatabase::getSiloSimpleType(const std::string& key, void *data)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
...
int SiloDatabase::getSiloSimpleTypeLength(const std::string& key)
{
#ifdef DEBUG_CHECK_ASSERTIONS
   TBOX_ASSERT(!key.empty());
#endif
...
std::string SiloDatabase::getName(void)
{
